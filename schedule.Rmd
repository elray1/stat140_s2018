 ...
 * **In class**, we will do the following:
    ...
    * Depending on results of in-class poll, we will either continue with inference for a population proportion, or start thinking about normal distributions and the sampling distribution of a sample mean.
