 ...
 * **In class**, we will do the following:
    ...
    * Briefly, review of the most important things in R so far: [pdf](lecture/20180130_wrangling/r_so_far.pdf)
    * Short lab about **data wrangling** in R on Gryd.
 ...
 * **Before class**, please do the following:
    * No new assignments
 * Start a lab about **data visualization** in R on Gryd
"
  )
```
...
#### Tue, Feb 6
 * **Before class**, please do the following:
    * Homework 4 is due today; will be assigned Friday, Feb 2.
 * **In Class**, we will do the following:
    * Finish off the lab about **data visualization** in R on Gryd

#### Thu, Feb 8
 * **Before class**, please do the following:
    * Homework 5 is due today; will be assigned Friday, Feb 2.
 * **In class**, we will do the following:
    * Lab about data wrangling
